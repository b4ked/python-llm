#!/usr/bin/env python3
"""
Update the embeddings table schema to support text-embedding-3-large (3072 dimensions)
instead of the default ada-002 (1536 dimensions).
"""
...
def update_embedding_schema():
    ...
    try:
        ...
        # Update the embedding column to support 1536 dimensions (text-embedding-3-small)
        print("🔄 Updating embedding column to support 1536 dimensions...")
        ...
        print("✓ Recreated vector similarity index")
...
def main():
    """Main function"""
    print("Embedding Schema Updater for text-embedding-3-small")
    print("=" * 60)
    print("This script will update the embeddings table to support")
    print("1536-dimension vectors from OpenAI's text-embedding-3-small model")
    print("=" * 60)
    ...
    if success:
        ...
        print("with the text-embedding-3-small model.")
        return 0
    else:
